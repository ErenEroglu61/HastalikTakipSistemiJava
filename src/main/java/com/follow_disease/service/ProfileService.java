...
public final class ProfileService {
    ...
    // Basit e-posta benzersizlik kontrolü (user.json içinde aynı e-posta varsa reddeder)
    // Eğer dosya bulunamazsa benzersizlik kontrolü atlanır (hata gösterme yerine esnek davranış tercih edildi)
    private static boolean isEmailUnique(String email, String myTc) {
        ...
        try {
            ...
            for (JsonElement el : arr) {
                ...
                if (tc.equals(myTc)) continue; // kendi kaydımızı atla
            ...
            // Okuma hatasında benzersizlik kontrolünü es geçiyoruz (daha toleranslı davran)
    ...
    public static boolean updateDoctor(User u, String age, String gender, String phone, String password) {
        ...
        // Phone normalizasyon ve kontrol (eğer doluysa 11 hane olmalı)
        ...
        // Password kuralı istersen burada eklenir (şu an boşsa değiştirmez, doluysa olduğu gibi setlenir)

        // Alanları setle (sadece geçerli/sağlananları)
